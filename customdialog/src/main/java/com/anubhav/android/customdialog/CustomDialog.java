package com.anubhav.android.customdialog;
...
public class CustomDialog extends Dialog implements View.OnClickListener {
    ...
    @UiThread
    private void setLayout(final CustomDialog dialog) {
    ...
    public interface BtnCallback {
        void onClick(@NonNull CustomDialog dialog, @NonNull BtnAction which);
    }

    public interface BtnCallbackWithPermanentCheck {
        void onClick(@NonNull CustomDialog dialog, @NonNull BtnAction which, boolean isPermanentChecked);
    }
    ...
    public static class Builder {
        ...
        @UiThread
        public CustomDialog showIfPermanentValueIsFalse() {
